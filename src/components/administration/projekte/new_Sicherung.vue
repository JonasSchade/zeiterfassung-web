...
<div class="newproject">
  <div class="container">
    ...
    <form class="container-flex">
      ...
      <div class="row" v-show='user_is_selected'>
      ...
      <div class="row">
        ...
        <div class="col-sm-9">
          <select name="manager" class="full-width" v-on:change="updateManager($event)" id="managerSelect" v-model="manager">
            <option disabled value="">Aus zugewiesenen Mitarbeitern wählen</option>
